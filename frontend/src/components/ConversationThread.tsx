...
const SHELF_EXAMPLE_META: Record<ToolKind, Omit<TaskExample, "prompt">> = {
  network: {
    tool: "网络搜索工具",
    title: "联网趋势研判",
...
const FILE_READ_EXAMPLE: TaskExample = {
  tool: "文件读取工具",
  title: "上传文件分析",
  prompt:
...
const TASK_EXAMPLES: TaskExample[] = [
  ...TOOL_SHELF.map((spec) => ({ ...SHELF_EXAMPLE_META[spec.kind], prompt: spec.prompt })),
  FILE_READ_EXAMPLE
];
